...
const CGFloat STBubbleImageSize = 30.0;
...
{	
    ...
    if (self)
    {
		...
		self.textLabel.font = [UIFont fontWithName:FONT_LBL_REG size:14.0];
...
- (void)updateFramesForAuthorType:(AuthorType)type
{
    ...
    {
      size = [self.textLabel.text boundingRectWithSize:CGSizeMake(self.frame.size.width - minInset - STBubbleWidthOffset - STBubbleImageSize - 8.0f, CGFLOAT_MAX)                                                                  options:NSStringDrawingUsesLineFragmentOrigin                                                                 attributes:@{NSFontAttributeName: self.textLabel.font}                                                                    context:nil].size;
	...
	else
    {
        ...
        size=[self.textLabel.text boundingRectWithSize:CGSizeMake(self.frame.size.width - minInset - STBubbleWidthOffset, CGFLOAT_MAX) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: self.textLabel.font}  context:nil].size;
...
{
	self.bubbleView.image = [[UIImage imageNamed:@"MesssageBG.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(12.0f, 15.0f, 16.0f, 18.0f)];
}
